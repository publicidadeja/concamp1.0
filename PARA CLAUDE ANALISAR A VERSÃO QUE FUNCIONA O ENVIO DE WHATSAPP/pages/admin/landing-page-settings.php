...
/* Footer */
.lp-footer {
    background-color: {$settings['lp_footer_bg_color']};
    color: " . hexToRgba(getContrastColor($settings['lp_footer_bg_color']), 0.7) . ";
}

.lp-footer-contact-icon,
.lp-footer h5 {
    color: {$settings['lp_primary_color']} !important;
}

.lp-footer-social-item:hover {
    background-color: {$settings['lp_primary_color']};
}
            ...
            <div class="col-12 mb-4">
                <div class="card">
                    <div class="card-body p-0">
                        ...
                        <div style="width: 100%; height: 60px; background-color: ${footerBgColor}; color: ${getTextColorForBackground(footerBgColor)}; display: flex; align-items: center; justify-content: center;">
